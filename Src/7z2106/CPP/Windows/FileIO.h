...
#define my_FSCTL_SET_REPARSE_POINT     CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 41, METHOD_BUFFERED, /*FILE_SPECIAL_ACCESS*/0) // REPARSE_DATA_BUFFER
...
#define my_FSCTL_DELETE_REPARSE_POINT  CTL_CODE(FILE_DEVICE_FILE_SYSTEM, 43, METHOD_BUFFERED, /*FILE_SPECIAL_ACCESS*/0) // REPARSE_DATA_BUFFER
